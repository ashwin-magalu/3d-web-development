...
// Decides which side of the face is visible (FrontSide (default), BackSide are other options)
...
// const material = new THREE.MeshLambertMaterial(); // This is the first material that requires light
...
// We use Environment with this material
...
// gui.add(material.iridescenceThicknessRange, "0").min(1).max(1000).step(10);
// gui.add(material.iridescenceThicknessRange, "1").min(1).max(1000).step(10);
...
gui.add(material, "ior").min(1).max(10).step(0.1);
